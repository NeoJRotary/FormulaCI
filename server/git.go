...
// func (api *API) getInfo(data interface{}, resFunc wsResFunc) {
// 	var pubkey = ""
...
// func (api *API) setEmail(data interface{}, resFunc wsResFunc) {
// 	email := data.(string)
...
// func (api *API) setWebhookToken(data interface{}, resFunc wsResFunc) {
// 	token := data.(string)
...
// func (api *API) generateSSH(data interface{}, resFunc wsResFunc) {
...
// func (api *API) pullRepo(name string, branch string, src string) (err error) {
...
// func (api *API) headSHA(name string, branch string) (string, error) {
// 	dir := repoPath + name + "/" + branch
...
// func (api *API) diffWithHEAD(name string, branch string, sha string) ([]string, error) {
// 	dir := repoPath + name + "/" + branch
